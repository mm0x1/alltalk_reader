    ...
    <div className="p-4 max-w-6xl mx-auto">
      ...
      {paragraphs.length === 0 ? (
        ...
        <div className="space-y-4">
          ...
          <div className="bg-dark-300 p-4 rounded-lg mb-1 space-y-4">
            {/* Playback Controls */}
            ...
            <div className="grid grid-cols-2 gap-2">
              ...
              <button
                ...
                className={`px-3 py-2 text-sm rounded flex items-center justify-center ${isPreGenerated
              ...
              >
                {isPreGenerated ? (
                  <>
                    ...
                    <span className="truncate">Pre-Generated</span>
                  </>
                ) : (
                  <>
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 mr-1.5 flex-shrink-0" viewBox="0 0 20 20" fill="currentColor">
                    ...
                    <span className="truncate">Pre-Generate</span>
                  </>
                )}
              </button>
              ...
              <button
                ...
                className={`px-3 py-2 text-sm rounded flex items-center justify-center transition-colors ${showBufferSettings
                  ? 'bg-accent-primary/20 text-accent-primary border border-accent-primary'
                  : 'bg-dark-400 hover:bg-dark-500 text-gray-300 border border-dark-500'
                  }`}
              >
                <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 mr-1.5 flex-shrink-0" viewBox="0 0 20 20" fill="currentColor">
                  <path fillRule="evenodd" d="M11.49 3.17c-.38-1.56-2.6-1.56-2.98 0a1.532 1.532 0 01-2.286.948c-1.372-.836-2.942.734-2.106 2.106.54.886.061 2.042-.947 2.287-1.561.379-1.561 2.6 0 2.978a1.532 1.532 0 01.947 2.287c-.836 1.372.734 2.942 2.106 2.106a1.532 1.532 0 012.287.947c.379 1.561 2.6 1.561 2.978 0a1.533 1.533 0 012.287-.947c1.372.836 2.942-.734 2.106-2.106a1.533 1.533 0 01.947-2.287c1.561-.379 1.561-2.6 0-2.978a1.532 1.532 0 01-.947-2.287c.836-1.372-.734-2.942-2.106-2.106a1.532 1.532 0 01-2.287-.947zM10 13a3 3 0 100-6 3 3 0 000 6z" clipRule="evenodd" />
                </svg>
                <span className="truncate">Buffer Settings</span>
              </button>

              {/* Export/Import */}
              <button
                onClick={openExportImport}
                className="px-3 py-2 text-sm rounded flex items-center justify-center bg-dark-400 text-white hover:bg-dark-500 border border-dark-500"
              >
                <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 mr-1.5 flex-shrink-0" viewBox="0 0 20 20" fill="currentColor">
                  <path fillRule="evenodd" d="M3 17a1 1 0 011-1h12a1 1 0 110 2H4a1 1 0 01-1-1zm3.293-7.707a1 1 0 011.414 0L9 10.586V3a1 1 0 112 0v7.586l1.293-1.293a1 1 0 111.414 1.414l-3 3a1 1 0 01-1.414 0l-3-3a1 1 0 010-1.414z" clipRule="evenodd" />
                </svg>
                <span className="truncate">{isOfflineSession ? "Offline Session" : "Export/Import"}</span>
              </button>
            </div>
          </div>
