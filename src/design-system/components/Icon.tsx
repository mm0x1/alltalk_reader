...
export const ICONS = {
  ...
  file: (
    <path 
      fillRule="evenodd" 
      d="M4 4a2 2 0 012-2h4.586A2 2 0 0112 2.586L15.414 6A2 2 0 0116 7.414V16a2 2 0 01-2.102 1.998l-6.674.875a1.998 1.998 0 01-2.215-1.642L4.838 13H4a2 2 0 01-2-2V6c0-1.1.9-2 2-2zm2 3a1 1 0 011-1h3a1 1 0 110 2H7a1 1 0 01-1-1zm0 3a1 1 0 011-1h6a1 1 0 110 2H7a1 1 0 01-1-1z" 
      clipRule="evenodd" 
    />
  ),
  lock: (
